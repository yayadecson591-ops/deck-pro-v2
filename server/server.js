...
app.get('/health',(req,res)=>res.json({ok:true,service:'deck-pro-server',version:'V120',status:'online',uptimeSec:Math.floor(process.uptime())}));
...
app.listen(PORT,'0.0.0.0',()=>console.log(`Deck Pro V120 server listening on :${PORT}`));
